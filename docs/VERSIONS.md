...
For new work, start from current `main` (current release `v1.1.0`). Unless a task explicitly requires another historical version, `main` is the baseline.
